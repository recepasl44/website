...
const Feature1: NextPage<Feature1Type> = ({ className = "", property1 = 1 }) => {
  return (
...
const Feature2: NextPage<Feature2Type> = ({ className = "", property1 = 1 }) => {
  return (
...
export type Feature3Type = {
  className?: string;
  /** Variant props */
  property1?: 1;
};

const Feature3: NextPage<Feature3Type> = ({ className = "", property1 = 1 }) => {
  return (
...
const DesignFeatures: NextPage = () => {
  return (
    <div className="page">
      <section className="submitCancelBackground">
        <Feature1 property1={2} />
        <Feature2 property1={1} />
        <Feature3 property1={1} />
      </section>

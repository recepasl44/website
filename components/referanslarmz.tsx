...
import FrameComponent2 from "./frame-component11";

export type ReferanslarmzType = {
  className?: string;
};
    ...
    >
      ...
      <div className="w-[1083.4px] h-[91px] flex flex-row items-start justify-end !pt-0 !pb-0 !pl-0 !pr-[563.4px] box-border z-[1]">
        <div className="h-[91px] w-[520px] flex flex-col items-start justify-start gap-2.5">
          ...
          <div className="flex flex-col items-center justify-start z-[1] text-2xl">
      ...
      <section className="flex flex-row items-center justify-start gap-[63.3px] z-[2]">
        ...
        <FrameComponent2
          groupDivWidth="444px"
          eBTEXIleHerContainerWidth="444px"
          mehmetKaya="Mehmet Kaya"
          yneticiABCEitimKurumlar="Frontend, TakEdutech"
          yneticiABCEitimAlignSelf="unset"
        />
        <FrameComponent2
          groupDivWidth="444px"
          eBTEXIleHerContainerWidth="444px"
          mehmetKaya="Uğur Yılmaz"
          yneticiABCEitimKurumlar="Frontend, TakEdutech"
          yneticiABCEitimAlignSelf="unset"
        />
      </section>
